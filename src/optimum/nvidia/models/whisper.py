...
#     TensorRTForSpeechSeq2Seq, WhisperGenerationMixin, HuggingFaceHubModel, SupportsTransformersConversion
# ):
#     MODEL_CONFIG = None
#     HF_LIBRARY_TARGET_MODEL_CLASS = TransformersWhisperForConditionalGeneration
#     TRT_LLM_TARGET_MODEL_CLASS = [TrtWhisperEncoder, TrtDecoderModel]
#
#     def __init__(
#         self,
...
#         torch.cuda.synchronize()
#
#         end_index = torch.max(self.decoder_generation_session.sequence_length_buffer) + 1
#         return output_ids[:, 0, :end_index]
